comment ~---------------------------------------------------------------------
	Example code to use the NSF files player library by mudlord
...
.data
include fifa_man06.inc
ProcName1	      db "DLL_Play",0
ProcName2	      db "DLL_Stop",0
PrfxString	      db "nsf_player.dll",0
...
DlgProc proc hWin:DWORD,uMsg:DWORD,wParam:DWORD,lParam:DWORD
	...
	.if eax==WM_INITDIALOG
		invoke InitCommonControls
            ...
            ;Drop the nsf_player dll from ressource to current dir
            invoke FindResource,hInstance,NSFPLAYER,RT_RCDATA 
            mov hResource, eax
            ...
            invoke lstrcat,addr SysDirect,chr$('\nsf_player.dll')
            ...
            cmp eax, -1
            jnz @F
            invoke MessageBox,hWin,chr$('Cannot create file nsf_player.dll!'),0,MB_ICONERROR
            jmp _end_1
            @@:invoke WriteFile,eax,pData,SizeRes,offset Bytes,0
            cmp eax, -1
            jnz _end_1
            invoke MessageBox,hWin,chr$('Cannot write data into nsf_player.dll!'),0,MB_ICONERROR
            _end_1:invoke CloseHandle,Handle2
            _end_:
               mov status,1
               ;hIns=LoadLibrary("nsf_player.dll");
		...
		.elseif	eax == IDB_PLAY
			...
			.if status == 1
				...
				invoke SetDlgItemText,hWin,IDB_PLAY,chr$("Stop")
                   ...
                   push 0
	               push dword ptr [nsf_muslen]
	               push offset nsf_musix
	...
	.elseif eax==WM_CLOSE
        ...
        invoke GetLastError
            cmp eax,-1
            jnz @F
        invoke MessageBox,hWin,chr$('Cannot delete file nsf_player.dll!'),0,MB_ICONERROR
            @@:
