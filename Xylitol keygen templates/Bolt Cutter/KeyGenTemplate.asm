...
;App text
WindowTitle       db "Keygen template Bolt Cutter",0
...
local TypeThread:DWORD
      ...
      .if uMsg == WM_INITDIALOG
         ...
         call music
         ;Load the buttons
         invoke ImageButton,hWnd,481,271,701,703,702,IDB_IDEXIT       
         mov hExit,eax
         invoke ImageButton,hWnd,193,287,601,603,602,IDB_IDSOUND        
         mov hSound,eax
         invoke ImageButton,hWnd,58,257,501,503,502,IDB_IDABOUT    
         mov hAbout,eax
         invoke ImageButton,hWnd,265,173,401,403,402,IDB_IDGENERATE
         mov hGenerate,eax
         ;Fade in
      ...
      .elseif uMsg == WM_CTLCOLOREDIT || uMsg == WM_CTLCOLORSTATIC
         invoke GetDlgCtrlID,lParam
            .if eax == IDC_SERIAL || IDC_NAME
                invoke SetBkMode,wParam,TRANSPARENT
                invoke SetTextColor,wParam,Black
                invoke SetBrushOrgEx,wParam,347,227,0    
                mov eax,hBgColor
                ret
            .endif
