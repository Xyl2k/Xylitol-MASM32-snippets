...
;  DESCRIPTION : Il s'agit d'un modèle de keygenerator que vous pouvez
;				 librement réutiliser, par exemple pour vos solutions
;				 de crackmes...
;				 Aucune routine de génération pour une application
;				 commerciale quelconque n'a été incluse.
; -------------------------------------------------------------------------
